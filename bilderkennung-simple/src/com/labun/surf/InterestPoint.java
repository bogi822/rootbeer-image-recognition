...
public class InterestPoint implements Serializable {
    ...
    public InterestPointPersistent createInterestPointPersistent(){
        return new InterestPointPersistent(x, y, strength, trace, scale, descriptor);
    }

    public String toString() {
        StringBuilder sb = new StringBuilder();
        Formatter f = new Formatter(sb, Locale.GERMANY); // (all output will be sent to sb)
